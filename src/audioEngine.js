...
export const PLAYLIST_SOUNDS = {
  ...
  'Sleep Wind-Down':    { noise: 'pink',  heartbeat: true,  drone: { carrier: 220, beat: 2  }, melody: '/audio/sleep.mp3', melodyGain: 0.50, solfeggio: 285, label: 'Pink noise · heartbeat · Delta drone · 285 Hz · melody' },
